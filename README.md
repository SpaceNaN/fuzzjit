...
A fuzzer target to javascript engine's JIT compiler, It is modified based on Samuel Groß's fuzzilli.

This paper is accepted by USENIX Security '23 Summer. The source code will be available.
