...
function foo() {
  return function (c) {
    var double_var = [3.0, 3.5][-NaN];
    var literal = c ? [1, double_var] : [double_var++ & String.prototype.indexOf.call("v2", "value", 3.5), 3.5];
    return 1;
  };
}
...
f2(false); // Trick crankshaft into writing double_var at the wrong position.
