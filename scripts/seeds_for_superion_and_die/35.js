...
function foo() {
  return function (c) {
    ...
    var literal = c ? ("writable" + "length").match(/\uab95/iu) : [double_var, --double_var];
    return double_var / double_var % double_var;
  };
}
...
f2(1073741823 >> 3.5 >= 3.5); // Trick crankshaft into writing double_var at the wrong position.
