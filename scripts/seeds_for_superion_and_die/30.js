...
function foo() {
  return function (c) {
    var double_var = [0, 3.5][1e-15.valueOf() / Number.prototype.valueOf.call(-NaN)];
    var literal = c ? [1, double_var] : [double_var, 3.5];
    return Array.prototype.map.call(literal.map(function () {
      +double_var;
      foo();
      return foo;
    }), function () {
      foo();
      literal[String.prototype.localeCompare.call("-0", "enumberable")]++;
    })[0];
  };
}
