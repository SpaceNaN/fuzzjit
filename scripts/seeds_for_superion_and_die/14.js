...
f1(Math.sqrt(0) == "+0".localeCompare(""));
f2(false); // Optimize f1, but don't initialize the [1, double_var] literal.

f1(Number.isSafeInteger(1 ** -NaN)); // Initialize the [1, double_var] literal, and transition the boilerplate to
// double.
