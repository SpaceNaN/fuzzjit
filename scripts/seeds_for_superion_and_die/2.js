...
function foo() {
  return function (c) {
    ...
    var literal = c ? [1, double_var] : [double_var, "valueOf".localeCompare("set") + (double_var ^ double_var)];
    return literal[0];
  };
}
...
f2((-1 | 3) < 0 >> 3.5); // Trick crankshaft into writing double_var at the wrong position.
