...
function foo() {
  return function (c) {
    var double_var = [String.prototype.padEnd.call("valueOf", 1, "apply").indexOf(3.5.toPrecision()), 3.5][0];
    var literal = c ? [1, double_var] : /^\s*at @?[a-zA-Z0-9_]/.exec("constructor");
    return literal[-NaN % double_var];
  };
}
