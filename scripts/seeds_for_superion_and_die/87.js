...
f1(false);
f2(String.prototype.includes.call("toString", "call".trimRight(), 1073741822 >> 0)); // Optimize f1, but don't initialize the [1, double_var] literal.
...
var l = f1(("apply" + "set").includes("valueOf", 1347440720));
1;
l;